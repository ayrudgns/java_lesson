...
// C42번을 MathProblem 클래스를 사용하는 것으로 바꾸기 : 연산은 덧셈만.
	public static void main(String[] args) {
		...
		for(int i = 0; i < size; i++) {
			MathProblem temp = new MathProblem('+');		// 곱셈을 하고 싶으면 객체('+')를 변경해주면 됨.
...
//			System.out.print("문제 " + (i + 1) + ". " + temp.getN1() + " + " + temp.getN2() + " = 답 입력 -> ");
			...
			problems[i] = temp;		// 이런 여기다 쓰는거 맞네.. Line 44 밑에만 채우는줄.. 하
		}
		System.out.println("=============================");
...
//			}	
	...
	// 추가 : 사용자가 입력한 ans를 저장해서 오답 출력시 같이 보여주고 싶다면? MathProblem 클래스의 Line 11 참조.
}
